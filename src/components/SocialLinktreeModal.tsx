...
export default function SocialLinktreeModal({ 
  ...
  const socialChannels = [
    ...
    },
    {
      name: 'LinkedIn',
      handle: '@growwithetdigital',
      url: 'https://linkedin.com/company/growwithetdigital',
      icon: LinkedInIcon,
    ...
    },
    {
      name: 'YouTube',
      handle: '@growwithetdigital',
      url: 'https://youtube.com/@growwithetdigital',
      icon: YouTubeIcon,
    ...
    },
    {
      name: 'X (Twitter)',
      handle: '@growwithetdigital',
      url: 'https://x.com/growwithetdigital',
      icon: XIcon,
    ...
    },
    {
      name: 'Facebook',
      handle: '@growwithetdigital',
      url: 'https://facebook.com/growwithetdigital',
      icon: FacebookIcon,
    ...
    },
    {
      name: 'Pinterest',
      handle: '@growwithetdigital',
      url: 'https://pinterest.com/growwithetdigital',
      icon: PinterestIcon,
    ...
    },
    {
      name: 'Reddit',
      handle: '@growwithetdigital',
      url: 'https://reddit.com/r/growwithetdigital',
      icon: RedditIcon,
